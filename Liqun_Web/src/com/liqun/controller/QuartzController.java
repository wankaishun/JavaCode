...
public class QuartzController {
	...
	@ResponseBody
	public Object toEdit(HttpServletRequest request,HttpServletResponse response) throws SchedulerException {
		...
		pd.put("jobGroupName", jobKey.getGroup());
	...
	public Object edit(HttpServletRequest request,HttpServletResponse response) throws SchedulerException, ClassNotFoundException {
		...
		String oldjobGroup = request.getParameter("oldjobGroupName");
		String oldtriggerName = request.getParameter("oldtriggerName");
		String oldtriggerGroup = request.getParameter("oldtriggerGroupName");
