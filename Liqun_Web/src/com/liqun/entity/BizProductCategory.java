...
/***TableName：[DBTable("biz_product_category")]***/
public final class  BizProductCategory  implements Serializable {
    /***private***/
	private Integer id;
	...
	public BizProductCategory(Integer id, String productCategoryNo,
			String productCategoryName, String reserve1, String reserve2,
			String reserve3, String reserve4, String reserve5, String flag,
	...
	public String toString() {
		return "BizProductCategory [id=" + id + ", productCategoryNo="
				+ productCategoryNo + ", productCategoryName="
				+ productCategoryName + ", reserve1=" + reserve1
				+ ", reserve2=" + reserve2 + ", reserve3=" + reserve3
				+ ", reserve4=" + reserve4 + ", reserve5=" + reserve5
				+ ", flag=" + flag + ", createUser=" + createUser
